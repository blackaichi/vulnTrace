...
// always-throwing helper in an instance field's VALUE, in a method BODY,
// and in a class defined inside an uncalled function. None of them runs
// when the class definition is evaluated, so c.js completes and its LATER
// (safe) export really is the value it publishes.
const c = require("./c");
