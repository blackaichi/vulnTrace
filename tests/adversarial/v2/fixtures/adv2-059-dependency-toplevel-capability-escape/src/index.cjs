...
// widening blocker under test is an authoritative loader-capability
// escape (`configure(Module)`) sitting entirely inside vt2-holder's own
// module (see node_modules/vt2-holder/index.js).
function main() {
