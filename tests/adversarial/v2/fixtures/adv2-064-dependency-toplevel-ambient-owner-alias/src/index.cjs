...
// widening blocker under test is an ALIASED AMBIENT OWNER
// (`const p = process;` then `p.mainModule.constructor._preloadModules`),
// sitting entirely inside vt2-holder's own module (see
