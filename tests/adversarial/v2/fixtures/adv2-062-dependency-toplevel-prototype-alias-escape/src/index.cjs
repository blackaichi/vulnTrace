...
// widening blocker under test is a PROVENANCE-RESOLUTION gap (Module.
// prototype held in a const, then used to reach a static loading
// primitive two property hops later), sitting entirely inside
