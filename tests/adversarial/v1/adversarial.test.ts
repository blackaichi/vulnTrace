 ...
 * projects under tests/adversarial/v1/fixtures/, never by running
 * VulnTrace and copying its output.
 *
...
const SUITE_ROOT = path.join(REPO_ROOT, "tests", "adversarial", "v1");
...
function writeReport(): void {
  ...
  lines.push("");
  lines.push(
    "Generated by `npm run test:adversarial` (`tests/adversarial/v1/adversarial.test.ts`). " +
      "Expected verdicts come from `tests/adversarial/v1/expected.json`, authored independently " +
